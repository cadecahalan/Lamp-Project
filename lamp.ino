...
int currentPin;
int timer = 100;
int lastServoPin = 6;  //just an initial value outside the length of the array
...
void loop() {
  ...
  while (currentPin == lastServoPin) {    //loop to make sure the same servo is not called twice in a row.  Less random random to make it have percieved randomness
